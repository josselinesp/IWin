...
@Component({
  selector: 'app-actualizar-juegos',
  templateUrl: './actualizar-juegos.component.html',
  styleUrls: ['./actualizar-juegos.component.css']
})
export class ActualizarJuegosComponent {
  ...
  buscarJuego(): void {
   /* console.log("entra en busca segunnnndo")
    this.http.get<Juego>(this.baseUrl + 'api/Juego/' + this.identificador).subscribe(result => {
      this.juego = result;
    }, error => console.error(error));*/
    /*
